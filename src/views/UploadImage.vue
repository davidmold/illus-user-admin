<template>
  <div>
    <p>
      Each image must be a JPEG. All images should be 2000 pixels wide at 72dpi. The file name must end with ".jpg", and must actually be a JPEG with RGB color space. Do not upload progressive or CMYK jpegs, they won't work on the site.
    </p>
    <p>
      Please note that the image file should be less than 5MB (five megabytes, or 5000K) file size. In Photoshop, the "Save for Web..." option is recommended. For the settings, choose "JPEG High" option.
    </p>
    <p>
      Default keywords shown below will be applied to all your image uploads. Use the edit link to add, change or remove them.
    </p>
    <table class="ttable">
      <tr>
...
export default {
  ...
  mounted () {
    this.$store.commit('setPageTitle', 'Upload a single image for your illustration portfolio')
  },
  created () {
    this.loadData()
  },
